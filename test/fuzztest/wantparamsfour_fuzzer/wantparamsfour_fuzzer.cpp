...
void CreateArrays(const char* data, std::map<std::string, sptr<IInterface>>& params)
{
    long size = static_cast<int32_t>(GetU32Data(data));

    sptr<IArray> booleanArray = new Array(size, g_IID_IBoolean);
    sptr<IArray> charArray = new Array(size, g_IID_IChar);
    sptr<IArray> byteArray = new Array(size, g_IID_IByte);
    sptr<IArray> shortArray = new Array(size, g_IID_IShort);
    sptr<IArray> integerArray = new Array(size, g_IID_IInteger);
    sptr<IArray> longArray = new Array(size, g_IID_ILong);
    sptr<IArray> floatArray = new Array(size, g_IID_IFloat);
    sptr<IArray> doubleArray = new Array(size, g_IID_IDouble);
    sptr<IArray> stringArray = new Array(size, g_IID_IString);
    sptr<IArray> wantParamsArray = new Array(size, g_IID_IWantParams);
    sptr<IArray> other = new Array(size, g_IID_IRemoteObjectWrap);
