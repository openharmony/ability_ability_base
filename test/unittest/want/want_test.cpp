...
HWTEST_F(WantBaseTest, AaFwk_Want_Parcelable_0200, Function | MediumTest | Level1)
{
    ...
    if (WantOut_ != nullptr) {
        pos2 = in.GetReadPosition();
        CompareWant(WantIn_, WantOut_);
        long retLong = Long::Unbox(ILong::Query(WantOut_->GetParams().GetParam(keyStr)));
        EXPECT_EQ(valueLong, retLong);
        GTEST_LOG_(INFO) << "Unmarshalling: pos1: " << pos1 << ", pos2: " << pos2 << ", result: " << result;
    }
    pos1 = in.GetReadPosition();
    std::shared_ptr<Want> WantOut2_(Want::Unmarshalling(in));
    if (WantOut2_ != nullptr) {
        pos2 = in.GetReadPosition();
        CompareWant(WantIn_, WantOut2_);
        long retLong = Long::Unbox(ILong::Query(WantOut2_->GetParams().GetParam(keyStr)));
        EXPECT_EQ(valueLong, retLong);
    }
}
 ...
 */
HWTEST_F(WantBaseTest, array_test_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(WantBaseTest, array_test_002, TestSize.Level1)
{
 ...
 */
HWTEST_F(WantBaseTest, array_test_003, TestSize.Level1)
{
 ...
 */
HWTEST_F(WantBaseTest, array_test_004, TestSize.Level1)
{
 ...
 */
HWTEST_F(WantBaseTest, array_test_005, TestSize.Level1)
{
